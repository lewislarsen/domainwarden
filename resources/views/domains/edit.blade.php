            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg px-12 py-8">
                <form method="POST" action="{{ route('domains.update', $domain) }}">
                    ...
                    <div>
                        ...
                        <x-text-input placeholder="{{ 'google.com' }}" value="{{ old('domain', $domain->domain) }}" id="domain" name="domain" type="text" class="mt-1 block w-full" autofocus autocomplete="domain" />
