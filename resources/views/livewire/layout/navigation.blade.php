...
<nav x-data="{ open: false }" class="bg-primary border-transparent">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('domains.index') }}" wire:navigate>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white focus:outline-none transition ease-in-out duration-150">
                            <img src="{{ Auth::user()->gravatar() }}" class="h-8 w-8 rounded-full border-transparent mr-2" />
